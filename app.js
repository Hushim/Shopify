...
const createShopping = require('./routes/createShopping');
const getPhotoImage = require('./routes/getItemImage');
...
app.use('/createShopping', createShopping);
app.use('/getPhotoImage', getPhotoImage);
